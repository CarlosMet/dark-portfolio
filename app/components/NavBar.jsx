...
export default function NavBar() {
  ...
  return (
    <header className='w-full bg-black/50 md:bg-white/10 fixed bottom-0 left-0 px-7 rounded-xl py-4 md:w-20 md:rounded-full md:gap-5 md:top-1/2   md:left-auto md:right-2 lg:right-3 md:h-80 lg:h-[520px] md:py-12 z-50'>
