...
export default function Page() {
  return (
    <section className='w-screen pb-24 lg:pb-0 flex flex-col lg:flex-row items-center pt-6 md:pt-1 gap-5 lg:gap-0 justify-center lg:pt-0 lg:justify-between relative'>
